 ...
 *
 * DISABLED: No filesystem on embedded platform
 */
 ...
 *
 * DISABLED: PSA headers not available on this platform
 */
 ...
 *
 * DISABLED: Requires MBEDTLS_PSA_CRYPTO_C which is disabled
 */
